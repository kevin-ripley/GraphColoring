...
public class GeneticAlgorithm {
     ...
     * @param populationSize an integer value for the initial population of
     * graph colorings to generate
     ...
     * Search Method
     *
     * @return true if a solution is found with 0 conflicts, false if no
     * solution found
     */
...
//            population.remove(b);
     ...
     *
     * @return probability of mutation represented as 1 in 1+(returned value)
     * probability
     */
     ...
     *
     * @param n the new probability of mutation as 1 in 1+n chance of mutation
     * (n=0 is 100% chance)
     */
     ...
     * Mutate Method
     *
     * @param child a recently reproduced child to have a vertex mutated with
     * probability 1 in 1+n
     ...
     *
     * @param n the integer number of randomly colored graphs for the initial
     * population
     * @return a population represented as an ArrayList of ArrayList<Vertex>
     * objects
     */
